            ...
            <Box sx={
                ...
                <Box sx={
                    ...
                    <Typography fontSize={'16px'}
                        fontWeight={'400'}
                        color='#505050'>
                        Best information about the company gies here but now lorem ipsum is</Typography>
                    <Box display={'flex'}
                        alignItems={'center'}
                        gap='10px'>
                ...
                <Box display={'flex'} alignItems={'start'} gap='60px' marginRight={'200px'}>
